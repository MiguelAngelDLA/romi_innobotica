...
public class FirstCuadrant {
    ...
    public Trajectory firstMove(){
        ...
        new Pose2d(0.23, -0.95, Rotation2d.fromDegrees(-90)),
        config);
    ...
    public Trajectory secondMove(){
        ...
        Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(0.23, -0.95, new Rotation2d(-90)),
        List.of(
            new Translation2d(0.3, -0.5)
        ),
        new Pose2d(0.3, -0, Rotation2d.fromDegrees(-90)),
        config);
    ...
    public Trajectory thirdMove(){
        ...
        Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(0.3, -0, new Rotation2d(-90)),
        List.of(
            new Translation2d(0.32, -0.3)
        ),
        new Pose2d(0.4, -0.4, Rotation2d.fromDegrees(-90)),
        config);
    ...
    public Trajectory fourthMove(){
        ...
        Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(0.4, -0.4, new Rotation2d(-90)),
        List.of(
            new Translation2d(0.5, -0.2)
        ),
        new Pose2d(0.6, -0.13, Rotation2d.fromDegrees(-90)),
        config);
    ...
    public Trajectory fithMove(){
        ...
        Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(0.6, -0.1, new Rotation2d(-90)),
        List.of(
            new Translation2d(0.75, -0.3)
        ),
        new Pose2d(1, -0.45, Rotation2d.fromDegrees(-90)),
        config);
    ...
    public Trajectory sixthMove(){
        ...
        Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(1.15, -0.45, new Rotation2d(-90)),
        List.of(
